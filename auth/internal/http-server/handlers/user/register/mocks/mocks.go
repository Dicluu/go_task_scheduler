...
func (_mock *MockUsecase) Register(ctx context.Context, email string, password string) (int64, error) {
...
//   - email string
//   - password string
func (_e *MockUsecase_Expecter) Register(ctx interface{}, email interface{}, password interface{}) *MockUsecase_Register_Call {
	return &MockUsecase_Register_Call{Call: _e.mock.On("Register", ctx, email, password)}
}

func (_c *MockUsecase_Register_Call) Run(run func(ctx context.Context, email string, password string)) *MockUsecase_Register_Call {
...
func (_c *MockUsecase_Register_Call) Return(n int64, err error) *MockUsecase_Register_Call {
	_c.Call.Return(n, err)
	return _c
}

func (_c *MockUsecase_Register_Call) RunAndReturn(run func(ctx context.Context, email string, password string) (int64, error)) *MockUsecase_Register_Call {
	_c.Call.Return(run)
	return _c
}
