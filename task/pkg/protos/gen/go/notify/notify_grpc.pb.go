...
func (c *notifierClient) Notify(ctx context.Context, opts ...grpc.CallOption) (Notifier_NotifyClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Notifier_serviceDesc.Streams[0], "/notify.Notifier/Notify", opts...)
	if err != nil {
		return nil, err
	}
...
type Notifier_NotifyClient interface {
	...
	CloseAndRecv() (*NotifyResponse, error)
	grpc.ClientStream
}
...
func (x *notifierNotifyClient) Send(m *NotifyRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *notifierNotifyClient) CloseAndRecv() (*NotifyResponse, error) {
...
func (x *notifierNotifyServer) SendAndClose(m *NotifyResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *notifierNotifyServer) Recv() (*NotifyRequest, error) {
	m := new(NotifyRequest)
